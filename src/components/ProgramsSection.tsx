...
import { Heart, ArrowRight } from "lucide-react"; // Tambahkan ArrowRight
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {programs.map((p, i) => {
                ...
                return (
                  ...
                  >
                    <Card 
                      // PERBAIKAN: Card sekarang bisa diklik untuk lihat detail
                      className="shadow-card hover:shadow-card-hover transition-all duration-300 overflow-hidden group h-full flex flex-col border border-gray-100 rounded-3xl cursor-pointer"
                    ...
                    >
                      ...
                      <CardContent className="p-6 flex flex-col flex-grow space-y-4">
                        ...
                        {/* PERBAIKAN: Tombol navigasi ke detail */}
                        <Button 
                          variant="gold" 
                          ...
                          onClick={(e) => {
                            e.stopPropagation(); // Mencegah double click karena card juga punya onClick
