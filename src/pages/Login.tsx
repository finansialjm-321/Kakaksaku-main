...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // 2. Pakai .maybeSingle() agar TIDAK ERROR jika profil belum ada
        ...
        // 3. Pengalihan cerdas. Jika profile null, anggap sebagai 'user' biasa
      ...
      // PENTING: Jika ada error di tengah jalan, paksa Logout!
      // Biar nggak kejadian "error tapi statusnya udah login" di navbar
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-xs text-gold font-bold hover:underline">
                Lupa Password?
              </Link>
            </div>
