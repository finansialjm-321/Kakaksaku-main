...
export default function Status() {
  ...
  // --- LOGIKA "NYAMBUNG" DINAMIS (DONATE VS KAKAK SAKU) ---
  const handlePayNow = async () => {
    ...
    try {
      if (billNo.startsWith('DON-')) {
        ...
        if (oldPayment) {
          // Arahkan ke rute KakasakuPayBill dengan state subId agar kalender terbuka lagi
          navigate('/kakasaku/pay-bill', { state: { subId: oldPayment.subscription_id } });
        } else {
