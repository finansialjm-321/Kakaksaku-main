          ...
          <div className="container mx-auto text-center max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-medium max-w-2xl mx-auto">
                Kakak Saku adalah program donasi rutin setiap bulan yang dirancang untuk memberikan kepastian masa depan bagi anak-anak di Jakarta.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Karena perubahan besar butuh waktu. Dukungan rutinmu memastikan akses edukasi adik-adik tidak terputus di tengah jalan dan mendampingi warga hingga benar-benar mandiri.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Dari kepedulianmu, lahir perubahan yang bisa dirasakan. Kontribusimu langsung bertransformasi menjadi buku-buku untuk adik-adik, modal usaha yang memberdayakan ekonomi warga lokal, hingga semen dan batu bata untuk memperkokoh fasilitas kampung binaan.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Kepercayaanmu adalah amanah terbesar kami. Pantau terus jejak kebaikanmu tanpa jeda. Melalui pembaruan real-time, kamu bisa melihat langsung progres dan senyum yang tercipta dari layar ponselmu hari ini juga.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="text-white/60 text-xl mb-16 max-w-xl mx-auto leading-relaxed">
                Bergabunglah bersama ratusan Kakak Saku lainnya dan berikan harapan baru bagi Jakarta setiap bulannya.
              </p>
