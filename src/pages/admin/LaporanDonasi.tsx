    ...
    <div className="min-h-screen bg-[#FDFCFB] flex text-[#1A1A1A]">
      ...
      <main className="flex-grow ml-0 md:ml-64 pt-16 md:pt-0 p-4 md:p-6 lg:p-10 transition-all">
        <header className="mb-6 md:mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-black tracking-tight">Laporan Donasi</h1>
            <p className="text-muted-foreground mt-1 font-medium italic text-sm md:text-base">Rekapitulasi dana sukses secara transparan.</p>
          </div>
          <button 
            onClick={downloadPDF}
