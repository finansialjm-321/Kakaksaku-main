...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] flex text-[#1A1A1A]">
      ...
      <main className="flex-grow ml-0 md:ml-64 pt-16 md:pt-0 p-4 md:p-6 lg:p-10 transition-all duration-300">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 md:mb-12">
          <div>
            ...
            <p className="text-muted-foreground font-medium italic text-sm md:text-base">Monitoring aktivitas hari ini.</p>
          </div>
