...
export default function Donate() {
  ...
  // --- LOGIKA REPAY: Membaca Data dari URL (Jika ada) ---
  ...
  // Inisialisasi State dengan data Repay atau Search Params awal
  ...
  // Jika nominal repay tidak ada di daftar tombol, masukkan ke input manual
  ...
  // Total Pembayaran Bersih (Merchant menanggung 0,7%)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Request link pembayaran via Edge Function (Nominal Pas)
          ...
          <Card className="shadow-2xl border-t-8 border-t-gold rounded-[2.5rem] overflow-hidden bg-white">
            <CardContent className="p-8 md:p-12 space-y-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                {/* Section: Sustainability Opsional */}
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between bg-gold/5 p-8 rounded-[2rem] border-2 border-gold/10 gap-4">
                    ...
                    {isTotalInvalid && (
                      <p className="text-red-600 text-sm italic font-bold max-w-[200px] text-center md:text-right">
                        Total donasi minimal Rp 10.000.
                      </p>
                    )}
                  </div>
